...
function randomise () {
    ...
    // Two more ways to swap:
    // 1. Detructuring => [num2,num1]=[num1,num2]
    // 2. swap => swap[num1,num2]
    ...
    // possible values 1=>+, 2=>-, 3=>*, 4=>/, 5=>%, 0=>run function again
...
switch(operator){
    ...
    case 4:
        ...
        // this will return a decimal thus we need to to typecast it to return integers thus math.floor rounds off to floor
        break;
